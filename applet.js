...
class CinnamonCalendarApplet extends Applet.TextApplet {
  constructor(orientation, panel_height, instance_id) {
    ...
    try {
      ...
      this._dateFormatFull = CinnamonDesktop.WallClock.lctime_format(
        "cinnamon",
        "%A, %B %-e, %Y"
      );
  ...
  _updateFormatString() {
    ...
    if (this.use_custom_format) {
      ...
      let show_seconds = this.desktop_settings.get_boolean(
        "clock-show-seconds"
      );
  ...
  _updateClockAndDate() {
    ...
    let dateFormattedFull = this.clock
      .get_clock_for_format(this._dateFormatFull)
      .capitalize();
